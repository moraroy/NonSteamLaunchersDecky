    ...
    <div className="decky-plugin">
      ...
      {updateInfo && updateInfo.status === "Update available" ? (
        <PanelSectionRow style={{ fontSize: "16px", fontWeight: "bold", marginBottom: "10px", textAlign: "center" }}>
          ...
          >
            <div>New update found! :) Pressing update will restart Steam. If the update does not work, please run the NSLPlugin.desktop in Desktop Mode.</div>
      ...
      <PanelSection title="Game Scanner">
        ...
        <PanelSectionRow style={{ fontSize: "12px", marginBottom: "10px" }}>
          The NSLGameScanner currently supports Epic Games Launcher, Ubisoft Connect, Gog Galaxy, The EA App, Battle.net, Amazon Games, Itch.io, Legacy Games, VK Play, HoYoPlay, Game Jolt Client, Minecraft Launcher, IndieGala Client, STOVE Client and Humble Bundle as well as Chrome Bookmarks for Xbox Game Pass, GeForce Now & Amazon Luna games, native linux NVIDIA GeForce NOW "Favorites", Waydroid Applications and Native Xbox App Games.
        </PanelSectionRow>
